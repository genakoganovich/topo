...
input = '../input/'+project_name+'/srtm_64_13.asc'
input2 = '../input/'+project_name+'/srtm_64_14.asc'
input3 = '../input/'+project_name+'/srtm_65_13.asc'
input4 = '../input/'+project_name+'/srtm_65_14.asc'
